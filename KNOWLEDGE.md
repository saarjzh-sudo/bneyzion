...
- **Categories row nudged** right+down for aesthetics: `transform: translate(22px, 6px)` on the desktop `<nav>` (physical px — translateX+ = toward logo in RTL; no reflow, no wrap risk).

    ...
    try {
      ...
      const res = await fetch("/api/grow/create-payment", {
        ...
        body: JSON.stringify({
          ...
          phone: donorPhone,
          email: donorEmail,
          // product-driven path: wallet (not directDebit) → Grow routes to
          // secure.meshulam.co.il/purchase (one-time), NOT credit-checkout.
          type: "product",
          meta: {
            product: "yehoshua-campaign",
            tos_accepted: true,
            tos_accepted_at: tosAt,
          },

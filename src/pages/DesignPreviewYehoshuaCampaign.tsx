...
const TIERS: Tier[] = [
  ...
  {
    id: "tier-yehoshua-shoftim",
    price: 220,
    name: "יהושע + שופטים",
    headline: "שני הספרים יחד — יהושע ושופטים — עד הבית",
    badge: "הכי מבוקש",
    limit: 150,
    remaining: 150,
    perks: ["ספר יהושע פיזי", "ספר שופטים פיזי", "משלוח עד הבית"],
    image: "/images/yoav-campaign/books-yehoshua-shoftim.jpg",
    imageAlt: "ספר יהושע וספר שופטים זה לצד זה",
  },
  {
    id: "tier-400",
    price: 400,
    ...
    image: "/images/yoav-campaign/set-five-megillot.webp",

/**
 * /parasha — Production weekly parasha page.
 *
...
// ── Biblical SVG icons (24px, line-art) ───────────────────────────────────
...
const ParashaPage = () => {
  ...
  const scrollTo = useCallback((id: string) => {
    const el = document.getElementById(id);
    if (!el) return;
    const top = el.getBoundingClientRect().top + window.scrollY - 96 - 56 - 16;
        ...
        <div className="container max-w-3xl" dir="rtl">
          ...
          {articlesWithContent.map((article, i) => (
            ...
            >
              ...
              {i > 0 && (
                <div className="flex items-center gap-4 my-10 print:my-4" aria-hidden>
                  <div className="flex-1 h-px" style={{ background: "rgba(139,111,71,0.2)" }} />
              ...
              >
                <div
                  ...
                  style={{ height: "2.5rem", background: gradients.goldButton }}
                />

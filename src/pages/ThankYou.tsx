    ...
    <section style={cardStyle} aria-label="הספרים הדיגיטליים שלך">
      ...
      {state === "ready" && (
        <div style={{ display: "grid", gap: "0.75rem" }}>
          ...
          {/* רמה 18 (יואב 14.7): לציין בתהליך ההורדה שהקובץ אישי ולא לשיתוף */}
          <p style={{ margin: 0, fontSize: "0.8rem", opacity: 0.7 }}>
            הקובץ אישי, לשימושך בלבד — נשמח שלא יועבר הלאה. כך אנחנו יכולים
            להמשיך להוציא ספרים חדשים.
          </p>
        </div>
      )}
    </section>
    ...
    >
      ...
      <section style={cardStyle} aria-label="מה קורה עכשיו">
        ...
        <div style={{ display: "grid", gap: "0.75rem" }}>
          ...
          <InfoRow
            icon={BookOpen}
            title="רכשת קורס? כך פותחים אותו"
            body="מתחברים לאתר עם Google — עם אותו מייל שאיתו רכשת — והקורס נפתח אוטומטית באזור האישי."
          />
          <InfoRow
            icon={Package}
            title="משלוח"

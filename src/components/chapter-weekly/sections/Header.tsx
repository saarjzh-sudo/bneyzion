  ...
  <header className="py-2 md:py-3 px-4 bg-cream-warm border-b border-border/30">
    <div className="max-w-6xl mx-auto flex items-center justify-between">
      ...
      <a
        ...
        className="bg-primary text-primary-foreground px-5 py-2.5 rounded-lg font-semibold text-sm md:text-base transition-all duration-300 hover:shadow-premium hover:scale-105"
      >
        הצטרפות לתכנית
      </a>
    </div>

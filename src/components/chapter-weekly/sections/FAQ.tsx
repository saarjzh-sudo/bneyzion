...
כרגע לומדים את חגי, זכריה ומלאכי – נביאי הבית השני. כל שבוע לומדים פרק אחד לעומק, בצורה מסודרת ובהירה: הכנה קצרה עם חומרים כתובים ומוקלטים, ולאחריה שיעור זום שבועי חי עם הרב יואב אוריאל – מורה ותיק ומומחה לתנ"ך.
...
במשך 15 שנה הוא מלמד תנ"ך בשיטה שמשלבת עומק, סדר ובהירות – עם חיבור אמיתי למסורת ולמקורות, ובצד זה גם רלוונטיות חיה לדור שלנו.`
  },
  {
    ...
    answer: `בכל יום רביעי בשעה 21:00 – שיעור זום חי של כשעה עם הרב יואב אוריאל.
לא יכולים להגיע בשידור חי? ההקלטה המלאה + סיכום כתוב זמינים כבר למחרת – ותוכלו ללמוד בזמן ובקצב שלכם.`
  },
  {
    question: "מה אורך התוכנית?",
    answer: `התכנית נבנית כסדרה רציפה של ספרי תנ"ך – כרגע לומדים את חגי, זכריה ומלאכי, ובהמשך נעבור לספרים נוספים (עזרא, נחמיה, דניאל ועוד) לפי הסדר.
...
התכנים בנויים כך שיתנו הבנה מקיפה ומדויקת, ובמקביל יפתחו כיווני מחשבה אמוניים ורעיוניים רלוונטיים להיום.`
  },
  {
    ...
    answer: `אפשר לכתוב לנו בוואטסאפ למספר 052-747-1094 או במייל office@bneyzion.co.il – ונחזור אליך בהקדם.`
  }
];

...
export const SITE_COPY_REGISTRY: CopyField[] = [
  ...
  // ── רמה 29ב (יואב 26.7 23:19: "אשמח לערוך את מה שמופיע כאן בדף הבית") ──
  // כותרת סקשן "תנ״ך למשפחה"; הכרטיסים עצמם נערכים באדמין → עריכת תוכן → תנ״ך למשפחה
  {
    key: "copy.home.family_title",
    label: "סקשן תנ״ך למשפחה — כותרת",
    group: "דף הבית",
    type: "text",
    defaultValue: "תנ״ך למשפחה",
  },
  {
    key: "copy.home.family_subtitle",
    label: "סקשן תנ״ך למשפחה — שורת המשנה",
    group: "דף הבית",
    type: "text",
    defaultValue: "הלימוד היומי",
    hint: "השורה הקטנה מתחת לכותרת המוזהבת; תוכן שלושת הכרטיסים נערך באדמין → עריכת תוכן → תנ״ך למשפחה",
  },
